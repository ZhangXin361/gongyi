...
<div style=" background:url(images/b1.jpg);  margin:0 auto;  width:1000px; ">

<br></br>
<p align="center"><b><font size="40" color="#43CD80" face="华文新魏">募&nbsp;&nbsp;捐&nbsp;&nbsp;区</font></b></p>
<br></br>
...
<%
try{
String product_name,product_bb,product_type,product_tell,product_na;
int product_id,product_price,product_discount,product_count;
product_type=new String(request.getParameter("search").getBytes("ISO8859_1"));
//根据选择类别，将信息显示出来
//String sql1="select * from clothelist where product_type='"+product_type+"'";
...
%>
 ...
 //计算记录总数 
String sql="select count(*) from clothelist where product_type='"+product_type+"'";
...
<table border=2 width="100%">
 ...
 <tr bgcolor="#33CCFF">
  ...
  <td>物品名称</td><td>捐物需求量</td><td>物资寄送地址</td><td>收件者</td><td>收件电话</td>
...
//int product_id,product_count;
 //打开数据库
 sql = "select * from clothelist where product_type='"+product_type+"' order by product_id desc";
...
while (k<pagesize && rs.next())
{
	...
	product_count=rs.getInt(4);
	product_na=rs.getString(6);
	product_tell=rs.getString(7);

out.print("<tr><td>"+product_name+"</td>");
out.print("<td>"+product_count+"</td>");
out.print("<td>"+product_bb+"</td>");
out.print("<td>"+product_na+"</td>");
out.print("<td>"+product_tell+"</td>");
out.print("<td><a href=cart2.jsp?product_id="+product_id+" >加入捐物区</a></td>");
...
<center><font color="#FF0000">&nbsp;</font><a href=index1.jsp><font color="#FF0000">发起求助</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=../index/index1.jsp><font color="#FF0000">返回主页</font></a><font color="#FF9933">&nbsp;
</font>
